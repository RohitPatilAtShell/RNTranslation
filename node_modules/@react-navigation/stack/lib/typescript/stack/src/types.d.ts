...
import { NavigationProp, ParamListBase, Descriptor, Route, NavigationHelpers } from '@react-navigation/core';
...
export declare type StackNavigationHelpers = NavigationHelpers<ParamListBase, StackNavigationEventMap>;
export declare type StackNavigationProp<ParamList extends ParamListBase, RouteName extends keyof ParamList = string> = NavigationProp<ParamList, RouteName, StackNavigationState, StackNavigationOptions, StackNavigationEventMap> & {
    /**
...
export declare type GestureDirection = 'horizontal' | 'vertical';
...
export declare type StackDescriptor = Descriptor<ParamListBase, string, StackNavigationState, StackNavigationOptions>;
