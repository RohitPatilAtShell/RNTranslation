...
export declare type InitialState = Partial<Omit<NavigationState, 'stale' | 'routes'>> & {
    routes: Array<Omit<Route<string>, 'key'> & {
        state?: InitialState;
    }>;
};
export declare type PartialState<State extends NavigationState> = Partial<Omit<State, 'stale' | 'type' | 'key' | 'routes' | 'routeNames'>> & {
    stale?: true;
    type?: string;
    routes: Array<Omit<Route<string>, 'key'> & {
        key?: string;
...
export declare type Route<RouteName extends string> = {
    /**
...
export declare type DefaultRouterOptions = {
    /**
...
export declare type EventMapBase = {
    focus: undefined;
    blur: undefined;
};
...
export declare type EventListenerCallback<EventName extends string, Data> = (e: EventArg<EventName, Data>) => void;
export declare type EventConsumer<EventMap extends Record<string, any>> = {
    /**
     ...
     */
    addListener<EventName extends Extract<keyof EventMap, string>>(type: EventName, callback: EventListenerCallback<EventName, EventMap[EventName]>): () => void;
    removeListener<EventName extends Extract<keyof EventMap, string>>(type: EventName, callback: EventListenerCallback<EventName, EventMap[EventName]>): void;
};
export declare type EventEmitter<EventMap extends Record<string, any>> = {
    /**
...
export declare class PrivateValueStore<A, B, C> {
     ...
     */
    private __private_value_type_a?;
    private __private_value_type_b?;
    private __private_value_type_c?;
}
...
export declare type NavigationHelpers<ParamList extends ParamListBase, EventMap extends Record<string, any> = {}> = NavigationHelpersCommon<ParamList> & EventEmitter<EventMap> & {
    /**
...
export declare type Descriptor<ParamList extends ParamListBase, RouteName extends keyof ParamList = string, State extends NavigationState = NavigationState, ScreenOptions extends object = {}, EventMap extends Record<string, any> = {}> = {
    /**
...
export declare type RouteConfig<ParamList extends ParamListBase, RouteName extends keyof ParamList, ScreenOptions extends object> = {
    /**
...
export declare type NavigationContainerRef = (NavigationHelpers<ParamListBase> & {
    /**
     * Reset the navigation state of the root navigator to the provided state.
     *
     * @param state Navigation state object.
...
export declare type TypedNavigator<ParamList extends ParamListBase, ScreenOptions extends object, Navigator extends React.ComponentType<any>> = {
    /**
     ...
     */
    Screen: <RouteName extends keyof ParamList>(_: RouteConfig<ParamList, RouteName, ScreenOptions>) => null;
};
export {};
