...
import { TouchableWithoutFeedbackProps, AccessibilityRole, AccessibilityStates, StyleProp, TextStyle, ViewStyle } from 'react-native';
import { NavigationHelpers, NavigationProp, ParamListBase, Descriptor, Route } from '@react-navigation/core';
...
export declare type BottomTabNavigationProp<ParamList extends ParamListBase, RouteName extends keyof ParamList = string> = NavigationProp<ParamList, RouteName, TabNavigationState, BottomTabNavigationOptions, BottomTabNavigationEventMap> & {
    /**
...
export declare type BottomTabBarProps = BottomTabBarOptions & {
    ...
    renderButton: (props: {
        route: Route<string>;
    } & BottomTabBarButtonProps) => React.ReactNode;
    renderIcon: (props: {
        route: Route<string>;
        focused: boolean;
        color: string;
